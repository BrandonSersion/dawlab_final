...
CREATE TABLE `movie` (
  ...
  CONSTRAINT `prefe_id` FOREIGN KEY (`prefe_id`) REFERENCES `preference` (`prefe_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-05-09 11:18:41
