...
/*!50001 VIEW `username` AS select `user`.`user_name` AS `user_name`,`user`.`firstname` AS `firstname` from `user` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Dumping events for database 'moviestream'
--

--
-- Dumping routines for database 'moviestream'
--
